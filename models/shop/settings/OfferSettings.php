...
namespace cmsgears\templates\breeze\models\shop\settings;

// Yii Imports
use Yii;

/**
 * OfferSettings provide page settings data.
 *
 * @since 1.0.0
 */
class OfferSettings extends \cmsgears\core\common\models\forms\DataModel {
