...
<div class="data-crud data-crud-settings data-crud-settings-notifications">
	...
	<div class="data-crud-form">
		<div class="row">
			<div class="col col2">
				<div class="frm-field row" cmt-app="core" cmt-controller="user" cmt-action="settings" action="<?= $apixBase ?>/toggle-meta?key=receive_email&ctype=<?= CoreGlobal::SETTINGS_NOTIFICATION ?>" cmt-keep>
					<?php include $apixSpinner; ?>
					<span class="cmt-switch cmt-checkbox">
						<input id="notify_receive_email" class="cmt-change cmt-toggle cmt-toggle-round" type="checkbox" name="value" />
						<label for="notify_receive_email"></label>
						<input type="hidden" name="value" value="<?php if( isset( $notification[ 'receive_email' ] ) ) echo $notification[ 'receive_email' ]->value; ?>" />
					</span>
