...
$options[ 'class' ] = isset( $options[ 'class' ] ) ? "page {$optionClass} $tclass page-category-{$template->type} page-{$model->slug}" : "page page-basic page-default $tclass page-model-{$template->type} page-{$model->slug}";
