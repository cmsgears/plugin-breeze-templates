...
$options[ 'class' ] = isset( $options[ 'class' ] ) ? "page {$optionClass} $tclass page-tag-{$template->type} page-{$model->slug}" : "page page-basic page-default $tclass page-model-{$template->type} page-{$model->slug}";
