...
<?php if( $content ) { ?>
	<div class="sidebar-content <?= $contentClass ?>">
		...
		<?php if( !empty( $contentSummary ) ) { ?>
			<div class="sidebar-content-summary reader"><?= $purifySummary ? HtmlPurifier::process( $contentSummary ) : $contentSummary ?></div>
		<?php } ?>
		<?php if( !empty( $contentData ) ) { ?>
			<div class="sidebar-content-data <?= $contentDataClass ?>"><?= $purifyContent ? HtmlPurifier::process( $contentData ) : $contentData ?></div>
		<?php } ?>
		<?php include $buffer; ?>
	</div>
<?php } ?>
