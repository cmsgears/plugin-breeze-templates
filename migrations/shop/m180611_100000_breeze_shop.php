...
class m180611_100000_breeze_shop extends \cmsgears\core\common\base\Migration {
	...
	private function insertPageTemplates() {
		...
		$templates = [
			...
			// Product Pages
			[ $master->id, $master->id, 'Shop', ShopGlobal::TEMPLATE_SHOP, CmsGlobal::TYPE_PAGE, null, null, true, 'Page layout to show products on shop page.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/page/default/forms', 'default', true, 'page/default', false, '@breeze/templates/cms/page/search', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ],
			[ $master->id, $master->id, 'Offers', ShopGlobal::TEMPLATE_OFFER, CmsGlobal::TYPE_PAGE, null, null, true, 'Page layout to show offers on offers page.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/page/default/forms', 'default', true, 'page/default', false, '@breeze/templates/cms/page/search', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ]
		];
