 ...
 * @since 1.0.0
 */
class m180611_100000_breeze_shop extends Migration {
	...
	private function insertProductTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Default', CoreGlobal::TEMPLATE_DEFAULT, ShopGlobal::TYPE_OFFER, null, true, 'Offer layout for offers.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\forms\settings\OfferSettings', '@breeze/templates/shop/offer/default/forms', 'default', true, 'offer/default', false, '@breeze/templates/shop/offer/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page page-basic page-offer" }', null, null ]
		];
