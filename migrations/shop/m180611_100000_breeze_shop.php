...
class m180611_100000_breeze_shop extends \cmsgears\core\common\base\Migration {
	...
	private function insertPageTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Shop', ShopGlobal::TEMPLATE_SHOP, CmsGlobal::TYPE_PAGE, null, true, 'Shop shows products with filters.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/page/default/forms', 'default', true, 'page/default', false, '@breeze/templates/shop/shop/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page page-basic page-payment" }', null, null ]
		];
	...
	private function insertWidgetTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Product Card', 'product-card', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author products.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\ProductConfig', '@breeze/templates/widget/shop/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/product', 'card', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-card widget-card-product" }', null, null ],
			[ $master->id, $master->id, 'Product Box', 'product-box', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author products.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\ProductConfig', '@breeze/templates/widget/shop/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/product', 'box', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-product" }', null, null ],
			[ $master->id, $master->id, 'Product Club', 'product-club', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author products clubbed from multiple sites.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\ProductConfig', '@breeze/templates/widget/shop/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/product', 'club', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-club widget-box-club-product" }', null, null ],
			[ $master->id, $master->id, 'Product Search', 'product-search', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to search products.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\ProductConfig', '@breeze/templates/widget/shop/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/product', 'search', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-search widget-box-search-product" }', null, null ],
			[ $master->id, $master->id, 'Product Home', 'product-home', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show products specifically on landing page.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\ProductConfig', '@breeze/templates/widget/shop/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/product', 'home', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-home widget-box-home-product" }', null, null ],
			[ $master->id, $master->id, 'Product Page', 'product-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show products specifically on single post page.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\ProductConfig', '@breeze/templates/widget/shop/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/product', 'page', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-product" }', null, null ],
			// Offer Widget - Default
			[ $master->id, $master->id, 'Offer Card', 'offer-card', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author offers.', 'cmsgears\widgets\blog\OfferWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\OfferConfig', '@breeze/templates/widget/shop/offer/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/offer', 'card', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-card widget-card-offer" }', null, null ],
			[ $master->id, $master->id, 'Offer Box', 'offer-box', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author offers.', 'cmsgears\widgets\blog\OfferWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\OfferConfig', '@breeze/templates/widget/shop/offer/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/offer', 'box', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-offer" }', null, null ],
			[ $master->id, $master->id, 'Offer Club', 'offer-club', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author offers clubbed from multiple sites.', 'cmsgears\widgets\blog\OfferWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\OfferConfig', '@breeze/templates/widget/shop/offer/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/offer', 'club', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-club widget-box-club-offer" }', null, null ],
			[ $master->id, $master->id, 'Offer Search', 'offer-search', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to search offers.', 'cmsgears\widgets\blog\OfferWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\OfferConfig', '@breeze/templates/widget/shop/offer/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/offer', 'search', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-search widget-box-search-offer" }', null, null ],
			[ $master->id, $master->id, 'Offer Home', 'offer-home', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show offers specifically on landing page.', 'cmsgears\widgets\blog\OfferWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\OfferConfig', '@breeze/templates/widget/shop/offer/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/offer', 'home', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-home widget-box-home-offer" }', null, null ],
			[ $master->id, $master->id, 'Offer Page', 'offer-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show offers specifically on single post page.', 'cmsgears\widgets\blog\OfferWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\shop\OfferConfig', '@breeze/templates/widget/shop/offer/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/shop/offer', 'page', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-offer" }', null, null ]
		];
