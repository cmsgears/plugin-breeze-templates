...
class m180611_100000_breeze_shop extends Migration {
	...
	private function insertWidgetTemplates() {
		...
		$templates = [
			// Job Widget - Default
			[ $master->id, $master->id, 'Product Card', 'product-card', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author products.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ProductConfig', '@breeze/templates/widget/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/product', 'card', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-card widget-card-product" }', null, null ],
			[ $master->id, $master->id, 'Product Box', 'product-box', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author products.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ProductConfig', '@breeze/templates/widget/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/product', 'box', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-product" }', null, null ],
			[ $master->id, $master->id, 'Product Club', 'product-club', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author products clubbed from multiple sites.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ProductConfig', '@breeze/templates/widget/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/product', 'club', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-club widget-box-club-product" }', null, null ],
			[ $master->id, $master->id, 'Product Search', 'product-search', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to search products.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ProductConfig', '@breeze/templates/widget/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/product', 'search', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-search widget-box-search-product" }', null, null ],
			[ $master->id, $master->id, 'Product Home', 'product-home', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show products specifically on landing page.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ProductConfig', '@breeze/templates/widget/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/product', 'home', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-home widget-box-home-product" }', null, null ],
			[ $master->id, $master->id, 'Product Page', 'product-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show products specifically on single post page.', 'cmsgears\widgets\blog\ProductWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ProductConfig', '@breeze/templates/widget/product/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/product', 'page', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-product" }', null, null ]
		];
