...
class m190720_100000_breeze_forum extends \cmsgears\core\common\base\Migration {
	...
	private function insertTopicTemplates() {
		...
		$templates = [
			// Default Templates - Forum
			[ $master->id, $master->id, 'Default', CoreGlobal::TEMPLATE_DEFAULT, ForumGlobal::TYPE_FORUM, null, true, true, 'Forum layout for forums.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\forum\settings\ForumSettings', '@breeze/templates/forum/forum/default/forms', 'default', true, 'forum/default', false, '@breeze/templates/forum/forum/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ],
	...
	private function insertWidgetTemplates() {
		...
		$templates = [
			// Forum Widget - Default
			[ $master->id, $master->id, 'Forum Card', 'forum-card', CmsGlobal::TYPE_WIDGET, null, null, true, false, 'It can be used to display popular, recent, and featured Forums.', 'cmsgears\widgets\club\cms\ForumWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\forum\ForumConfig', '@breeze/templates/widget/forum/forum/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/forum/forum', 'card', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-default widget-card widget-card-model widget-card-forum" }', null, null ],
			[ $master->id, $master->id, 'Forum Box', 'forum-box', CmsGlobal::TYPE_WIDGET, null, null, true, false, 'It can be used to display related and similar Forums.', 'cmsgears\widgets\club\cms\ForumWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\forum\ForumConfig', '@breeze/templates/widget/forum/forum/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/forum/forum', 'box', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-default widget-box widget-box-model widget-box-forum" }', null, null ],
			[ $master->id, $master->id, 'Forum Club', 'forum-club', CmsGlobal::TYPE_WIDGET, null, null, true, false, 'It can be used to display popular, recent, featured, related and similar Forums clubbed from multiple sites.', 'cmsgears\widgets\club\cms\ForumWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\forum\ForumConfig', '@breeze/templates/widget/forum/forum/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/forum/forum', 'club', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-default widget-box widget-box-club widget-box-club-forum" }', null, null ],
			[ $master->id, $master->id, 'Forum Search', 'forum-search', CmsGlobal::TYPE_WIDGET, null, null, true, false, 'It can be used to search Forums.', 'cmsgears\widgets\club\cms\ForumWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\forum\ForumConfig', '@breeze/templates/widget/forum/forum/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/forum/forum', 'search', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-default widget-box widget-box-search-model widget-box-search-forum" }', null, null ],
			[ $master->id, $master->id, 'Forum Home', 'forum-home', CmsGlobal::TYPE_WIDGET, null, null, true, false, 'It can be used to show Forums specifically on landing page.', 'cmsgears\widgets\club\cms\ForumWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\forum\ForumConfig', '@breeze/templates/widget/forum/forum/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/forum/forum', 'home', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-default widget-box widget-box-home widget-box-home-forum" }', null, null ],
			[ $master->id, $master->id, 'Forum Page', 'forum-page', CmsGlobal::TYPE_WIDGET, null, null, true, false, 'It can be used to show Forums specifically on single Forum page.', 'cmsgears\widgets\club\cms\ForumWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\forum\ForumConfig', '@breeze/templates/widget/forum/forum/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/forum/forum', 'default', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-default widget-box widget-box-page widget-box-page-forum" }', null, null ],
