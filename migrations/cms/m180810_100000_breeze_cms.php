...
class m180810_100000_breeze_cms extends Migration {
	...
	private function insertWidgetTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Article Home', 'article-home', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show posts specifically on landing page.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ArticleConfig', '@breeze/templates/widget/article/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/article', 'home', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-home widget-box-home-article" }', null, null ],
			[ $master->id, $master->id, 'Article Page', 'article-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show posts specifically on single post page.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ArticleConfig', '@breeze/templates/widget/article/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/article', 'page', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-article" }', null, null ],
			// Post Widget - Default
