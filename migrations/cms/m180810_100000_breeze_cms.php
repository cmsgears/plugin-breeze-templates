...
class m180810_100000_breeze_cms extends Migration {
	...
	private function insertBlockTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Slider', 'slider', CmsGlobal::TYPE_BLOCK, null, null, true, 'Form layout for blocks showing slider of elements.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\forms\settings\BlockSettings', '@breeze/templates/block/default/forms', 'default', true, null, false, '@breeze/templates/block/slider', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-max" }', null, null ],
