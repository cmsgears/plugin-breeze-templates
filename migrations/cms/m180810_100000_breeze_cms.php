...
class m180810_100000_breeze_cms extends Migration {
	...
	private function insertFormTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Contact', 'contact', CoreGlobal::TYPE_FORM, null, null, true, 'It can be used to display public forms.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\forms\settings\FormSettings', '@breeze/templates/form/default/forms', 'default', true, 'form/default', false, '@breeze/templates/form/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page page-basic page-default" }', null, null ]
		];
	...
	private function insertWidgetTemplates() {
		...
		$templates = [
			...
			// Page Widget - Default
			[ $master->id, $master->id, 'Page', CmsGlobal::TEMPLATE_PAGE, CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent and related pages.', 'cmsgears\widgets\blog\PageWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\PageConfig', '@breeze/templates/widget/page/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/page', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-page" }', null, null ],
			// Article Widget - Default
			[ $master->id, $master->id, 'Article', CmsGlobal::TEMPLATE_ARTICLE, CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author articles.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\ArticleConfig', '@breeze/templates/widget/article/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/article', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-article" }', null, null ],
			// Post Widget - Default
			[ $master->id, $master->id, 'Post', CmsGlobal::TEMPLATE_POST, CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, similar, related and author posts.', 'cmsgears\widgets\blog\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\forms\widget\PostConfig', '@breeze/templates/widget/post/forms', 'cmsgears\templates\breeze\models\forms\settings\WidgetSettings', '@breeze/templates/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/post', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget widget-basic widget-post" }', null, null ]
		];
