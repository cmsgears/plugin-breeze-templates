...
class m180610_100000_breeze_cms extends Migration {
	...
	private function insertPageTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Blog', 'blog', CmsGlobal::TYPE_PAGE, null, 'Blog', true, 'Blog layout to show blog posts on blog page.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/page/default/forms', 'default', true, 'page/default', false, '@breeze/templates/cms/page/blog', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ],
			// Article - Default
	...
	private function insertWidgetTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Slider', 'slider', CmsGlobal::TYPE_WIDGET, null, null, true, "Default layout for widgets showing slider of it's gallery.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/cms/widget/slider', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-slider" }', null, null ],
			...
			// Tags Widget - Default
			[ $master->id, $master->id, 'Tags', CmsGlobal::TEMPLATE_TAGS, CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display model categories and tags.', null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\TagConfig', '@breeze/templates/cms/widget/tag/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/cms/widget/tag', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-tags" }', null, null ],
			...
			[ $master->id, $master->id, 'Page Card', 'page-card', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent and related pages.', 'cmsgears\widgets\blog\PageWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PageConfig', '@breeze/templates/widget/cms/page/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/page', 'card', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-card widget-card-page" }', null, null ],
			[ $master->id, $master->id, 'Page Box', 'page-box', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent and related pages.', 'cmsgears\widgets\blog\PageWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PageConfig', '@breeze/templates/widget/cms/page/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/page', 'box', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page" }', null, null ],
			[ $master->id, $master->id, 'Page Search', 'page-search', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to search pages.', 'cmsgears\widgets\blog\PageWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PageConfig', '@breeze/templates/widget/cms/page/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/page', 'search', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-search widget-box-search-page" }', null, null ],
			// Article Widget - Default
			[ $master->id, $master->id, 'Article Card', 'article-card', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author articles.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\ArticleConfig', '@breeze/templates/widget/cms/article/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/article', 'card', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-card widget-card-article" }', null, null ],
			[ $master->id, $master->id, 'Article Box', 'article-box', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author articles.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\ArticleConfig', '@breeze/templates/widget/cms/article/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/article', 'box', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-article" }', null, null ],
			[ $master->id, $master->id, 'Article Club', 'article-club', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, related and author articles clubbed from multiple sites.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\ArticleConfig', '@breeze/templates/widget/cms/article/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/article', 'club', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-club widget-box-club-article" }', null, null ],
			[ $master->id, $master->id, 'Article Search', 'article-search', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to search articles.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\ArticleConfig', '@breeze/templates/widget/cms/article/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/article', 'search', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-search widget-box-search-article" }', null, null ],
			[ $master->id, $master->id, 'Article Home', 'article-home', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show articles specifically on landing page.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\ArticleConfig', '@breeze/templates/widget/cms/article/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/article', 'home', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-home widget-box-home-article" }', null, null ],
			[ $master->id, $master->id, 'Article Page', 'article-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show articles specifically on single post page.', 'cmsgears\widgets\blog\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\ArticleConfig', '@breeze/templates/widget/cms/article/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/article', 'page', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-article" }', null, null ],
			// Post Widget - Default
			[ $master->id, $master->id, 'Post Card', 'post-card', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, similar, related and author posts.', 'cmsgears\widgets\blog\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PostConfig', '@breeze/templates/widget/cms/post/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/post', 'card', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-card widget-card-post" }', null, null ],
			[ $master->id, $master->id, 'Post Box', 'post-box', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, similar, related and author posts.', 'cmsgears\widgets\blog\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PostConfig', '@breeze/templates/widget/cms/post/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/post', 'box', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-post" }', null, null ],
			[ $master->id, $master->id, 'Post Club', 'post-club', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display popular, recent, similar, related and author posts clubbed from multiple sites.', 'cmsgears\widgets\blog\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PostConfig', '@breeze/templates/widget/cms/post/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/post', 'club', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-club widget-box-club-post" }', null, null ],
			[ $master->id, $master->id, 'Post Search', 'post-search', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to search posts.', 'cmsgears\widgets\blog\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PostConfig', '@breeze/templates/widget/cms/post/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/post', 'search', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-search widget-box-search-post" }', null, null ],
			[ $master->id, $master->id, 'Post Home', 'post-home', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show posts specifically on landing page.', 'cmsgears\widgets\blog\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PostConfig', '@breeze/templates/widget/cms/post/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/post', 'home', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-home widget-box-home-post" }', null, null ],
			[ $master->id, $master->id, 'Post Page', 'post-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show posts specifically on single post page.', 'cmsgears\widgets\blog\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PostConfig', '@breeze/templates/widget/cms/post/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/post', 'page', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-post" }', null, null ],
