...
class m180610_100000_breeze_cms extends \cmsgears\core\common\base\Migration {
	...
	private function insertPageTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Blog', CmsGlobal::TEMPLATE_BLOG, CmsGlobal::TYPE_PAGE, null, null, true, 'Page layout to show blog posts on blog page.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/page/default/forms', 'default', true, 'page/default', false, '@breeze/templates/cms/page/search', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ],
			[ $master->id, $master->id, 'Articles', CmsGlobal::TEMPLATE_ARTICLE, CmsGlobal::TYPE_PAGE, null, null, true, 'Page layout to show blog posts on blog page.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/page/default/forms', 'default', true, 'page/default', false, '@breeze/templates/cms/page/search', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ],
			// Article - Default
			...
			// Post - Default
			[ $master->id, $master->id, 'Default', CoreGlobal::TEMPLATE_DEFAULT, CmsGlobal::TYPE_POST, null, null, true, 'Default post layout for single blog post.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/post/default/forms', 'default', true, 'post/default', true, '@breeze/templates/cms/post/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic" }', null, null ],
			[ $master->id, $master->id, 'Editor', CmsGlobal::TEMPLATE_EDITOR, CmsGlobal::TYPE_POST, null, null, true, 'Default post layout for single blog post.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/post/default/forms', 'default', true, 'post/default', true, '@breeze/templates/cms/post/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic" }', null, null ],
			[ $master->id, $master->id, 'Category', CmsGlobal::TEMPLATE_CATEGORY, CmsGlobal::TYPE_POST, null, null, true, 'Post layout for category posts.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/post/default/forms', 'default', true, 'post/default', false, '@breeze/templates/cms/post/category', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic" }', null, null ],
			[ $master->id, $master->id, 'Tag', CmsGlobal::TEMPLATE_TAG, CmsGlobal::TYPE_POST, null, null, true, 'Post layout for tag posts.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/post/default/forms', 'default', true, 'post/default', false, '@breeze/templates/cms/post/tag', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic" }', null, null ],
			[ $master->id, $master->id, 'Author', CmsGlobal::TEMPLATE_AUTHOR, CmsGlobal::TYPE_POST, null, null, true, 'Post layout for author posts.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/post/default/forms', 'default', true, 'post/default', false, '@breeze/templates/cms/post/author', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic" }', null, null ],
			[ $master->id, $master->id, 'Archive', CmsGlobal::TEMPLATE_ARCHIVE, CmsGlobal::TYPE_POST, null, null, true, 'Post layout for archive posts.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/post/default/forms', 'default', true, 'post/default', false, '@breeze/templates/cms/post/archive', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic" }', null, null ]
		];
	...
	private function insertFormTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Feedback', 'feedback', CoreGlobal::TYPE_FORM, null, null, true, 'It can be used to display feedback forms.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\FormSettings', '@breeze/templates/cms/form/default/forms', 'default', true, 'form/default', false, '@breeze/templates/cms/form/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ],
			[ $master->id, $master->id, 'Testimonial', 'testimonial', CoreGlobal::TYPE_FORM, null, null, true, 'It can be used to display testimonial forms.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\FormSettings', '@breeze/templates/cms/form/default/forms', 'default', true, 'form/default', false, '@breeze/templates/cms/form/default', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ]
		];
	...
	private function insertElementTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Card Text', 'card-text', CmsGlobal::TYPE_ELEMENT, null, null, true, 'Default layout for card elements showing text.', null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\element\card\TextConfig', '@breeze/templates/cms/element/card/text/forms', 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/card/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/card/text', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "card card-basic card-default" }', null, null ],
			[ $master->id, $master->id, 'Card Gallery', 'card-gallery', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for card elements showing it's gallery.", null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\element\card\GalleryConfig', '@breeze/templates/cms/element/card/gallery/forms', 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/card/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/card/gallery', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "card card-basic card-default" }', null, null ],
			[ $master->id, $master->id, 'Card Slider', 'card-slider', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for card elements showing slider of it's gallery.", null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\element\card\SliderConfig', '@breeze/templates/cms/element/card/slider/gallery/forms', 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/card/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/card/slider/gallery', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "card card-basic card-default card-slider-default" }', null, null ],
			[ $master->id, $master->id, 'Card Attributes Slider', 'card-attributes-slider', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for card elements showing slider of it's attributes.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/card/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/card/slider/attributes', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "card card-basic card-default card-slider-attributes" }', null, null ],
			[ $master->id, $master->id, 'Card Attributes Accordian', 'card-attributes-accordian', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for card elements showing accordian of it's attributes.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/card/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/card/accordian/attributes', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "card card-basic card-default" }', null, null ],
			...
			[ $master->id, $master->id, 'Box Text', 'box-text', CmsGlobal::TYPE_ELEMENT, null, null, true, 'Default layout for box elements showing text.', null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\element\box\TextConfig', '@breeze/templates/cms/element/box/text/forms', 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/box/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/box/text', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "box box-basic box-default" }', null, null ],
			[ $master->id, $master->id, 'Box Gallery', 'box-gallery', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for box elements showing it's gallery.", null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\element\box\GalleryConfig', '@breeze/templates/cms/element/box/gallery/forms', 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/box/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/box/gallery', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "box box-basic box-default" }', null, null ],
			[ $master->id, $master->id, 'Box Slider', 'box-slider', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for box elements showing slider of it's gallery.", null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\element\box\SliderConfig', '@breeze/templates/cms/element/box/slider/gallery/forms', 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/box/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/box/slider/gallery', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "box box-basic box-default box-slider-default" }', null, null ],
			[ $master->id, $master->id, 'Box Attributes Slider', 'box-attributes-slider', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for box elements showing slider of it's attributes.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/box/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/box/slider/attributes', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "box box-basic box-default box-slider-attributes" }', null, null ],
			[ $master->id, $master->id, 'Box Attributes Accordian', 'box-attributes-accordian', CmsGlobal::TYPE_ELEMENT, null, null, true, "Default layout for box elements showing accordian of it's attributes.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/box/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/box/accordian/attributes', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "box box-basic box-default" }', null, null ],
			...
			// Element - ZigZag
			[ $master->id, $master->id, 'ZigZag', 'zigzag', CmsGlobal::TYPE_ELEMENT, null, null, true, 'Default layout for elements arranged in zigzag fashion. The parent wrapper can be assigned with the CSS class - data-zigzag.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\ElementSettings', '@breeze/templates/cms/element/box/default/forms', 'default', true, null, false, '@breeze/templates/cms/element/zigzag', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "element element-zigzag" }', null, null ]
		];
	...
	private function insertBlockTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Text', CoreGlobal::TEMPLATE_DEFAULT, CmsGlobal::TYPE_BLOCK, null, null, true, 'Default layout for blocks showing text.', null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\block\TextConfig', '@breeze/templates/cms/block/text/forms', 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/text', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default" }', null, null ],
			[ $master->id, $master->id, 'Social', CmsGlobal::TEMPLATE_SOCIAL, CmsGlobal::TYPE_BLOCK, null, null, true, 'It can be used to display social links using social attributes.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/social', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default" }', null, null ],
			[ $master->id, $master->id, 'Gallery', CmsGlobal::TEMPLATE_GALLERY, CmsGlobal::TYPE_BLOCK, null, null, true, "Default layout for blocks showing it's gallery.", null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\block\GalleryConfig', '@breeze/templates/cms/block/gallery/forms', 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/gallery', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default" }', null, null ],
			[ $master->id, $master->id, 'Slider', CmsGlobal::TEMPLATE_SLIDER, CmsGlobal::TYPE_BLOCK, null, null, true, "Default layout for blocks showing slider of it's gallery.", null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\block\SliderConfig', '@breeze/templates/cms/block/slider/gallery/forms', 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/slider/gallery', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default block-slider-default" }', null, null ],
			[ $master->id, $master->id, 'Attributes Slider', CmsGlobal::TEMPLATE_ATTRIBUTES_SLIDER, CmsGlobal::TYPE_BLOCK, null, null, true, "Default layout for blocks showing slider of it's attributes.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/slider/attributes', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default block-slider-attributes" }', null, null ],
			[ $master->id, $master->id, 'Elements Slider', 'elements-slider', CmsGlobal::TYPE_BLOCK, null, null, true, "Default layout for blocks showing slider of it's elements.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/slider/elements', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default block-slider-elements" }', null, null ],
			[ $master->id, $master->id, 'Attributes Accordian', CmsGlobal::TEMPLATE_ATTRIBUTES_ACCORDIAN, CmsGlobal::TYPE_BLOCK, null, null, true, "Default layout for blocks showing accordian of it's attributes.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/accordian/attributes', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default" }', null, null ],
			[ $master->id, $master->id, 'Elements Accordian', 'elements-accordian', CmsGlobal::TYPE_BLOCK, null, null, true, "Default layout for blocks showing accordian of it's elements.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/accordian/elements', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default" }', null, null ],
			[ $master->id, $master->id, 'Elements ZigZag', 'elements-zigzag', CmsGlobal::TYPE_BLOCK, null, null, true, "Default layout for blocks showing elements in zigzag arrangement.", null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\BlockSettings', '@breeze/templates/cms/block/default/forms', 'default', true, null, false, '@breeze/templates/cms/block/zigzag', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "block-basic block-default" }', null, null ],
	...
	private function insertWidgetTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Search', CmsGlobal::TEMPLATE_SEARCH, CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display page, article and post search form.', null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\widget\SearchConfig', '@breeze/templates/cms/widget/search/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/cms/widget/search', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-search" }', null, null ],
			...
			// Tags Widget - Default
			[ $master->id, $master->id, 'Tag Cloud', CmsGlobal::TEMPLATE_TAG_CLOUD, CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to display model categories and tags.', null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\config\widget\TagConfig', '@breeze/templates/cms/widget/tag/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/cms/widget/tag', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-tags" }', null, null ],
			...
			[ $master->id, $master->id, 'Article Page', 'article-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show articles specifically on single post page.', 'cmsgears\widgets\club\cms\ArticleWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\ArticleConfig', '@breeze/templates/widget/cms/article/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/article', 'default', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-article" }', null, null ],
			// Post Widget - Default
			...
			[ $master->id, $master->id, 'Post Page', 'post-page', CmsGlobal::TYPE_WIDGET, null, null, true, 'It can be used to show posts specifically on single post page.', 'cmsgears\widgets\club\cms\PostWidget', null, null, null, null, 'cmsgears\templates\breeze\models\widget\cms\PostConfig', '@breeze/templates/widget/cms/post/forms', 'cmsgears\templates\breeze\models\cms\settings\WidgetSettings', '@breeze/templates/cms/widget/default/forms', 'default', true, null, false, '@breeze/templates/widget/cms/post', 'default', DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "widget-basic widget-box widget-box-page widget-box-page-post" }', null, null ],
