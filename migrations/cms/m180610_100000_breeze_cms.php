...
class m180610_100000_breeze_cms extends \cmsgears\core\common\base\Migration {
	...
	private function insertPageTemplates() {
		...
		$templates = [
			...
			[ $master->id, $master->id, 'Search', CmsGlobal::TEMPLATE_SEARCH, CmsGlobal::TYPE_PAGE, null, null, true, 'Page layout for search pages.', null, null, null, null, null, null, null, 'cmsgears\templates\breeze\models\cms\settings\PageSettings', '@breeze/templates/cms/page/default/forms', 'default', true, 'page/default', false, '@breeze/templates/cms/page/search', null, DateUtil::getDateTime(), DateUtil::getDateTime(), '{ "class": "page-basic page-default" }', null, null ],
